...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{V_09d5b72f962e43dc9304ab8adb90b75b.png}}
  \caption{Diagrama de cortante \(V(x)\) en \(\SI{}{kN}\).}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{M_ef8bcdae66304349bf8be904b38d2034.png}}
