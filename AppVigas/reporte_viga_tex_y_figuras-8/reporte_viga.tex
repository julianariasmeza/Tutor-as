...
\(\mathrm{R}(x=\SI{0.000}{\metre})\) & \SI{6.6000}{\kilo\newton} \\
\(\mathrm{R}(x=\SI{5.000}{\metre})\) & \SI{5.4000}{\kilo\newton} \\
\end{tabular}
\end{center}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{V_6ef9eb9b924248049e7318c5c11d5786.png}}
  \caption{Diagrama de cortante \(V(x)\) en \(\SI{}{kN}\).}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{M_e69d55f4eb8f469985ba376c523b2fba.png}}
