...
\(\mathrm{R}(x=\SI{0.000}{\metre})\) & \SI{6.0000}{\kilo\newton} \\
\(\mathrm{R}(x=\SI{5.000}{\metre})\) & \SI{6.0000}{\kilo\newton} \\
\end{tabular}
\end{center}
...
\(\SI{-6.0000}{\kilo\newton}\) en \(x=\SI{5.000}{\metre}\) &
\(\SI{6.0000}{\kilo\newton}\) en \(x=\SI{0.000}{\metre}\) \\
\(M\) & \(\SI{8.7500}{\kilo\newton\metre}\) en \(x=\SI{2.500}{\metre}\) &
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{V_bedd932eab554de781519fb8e17ca249.png}}
  \caption{Diagrama de cortante \(V(x)\) en \(\SI{}{kN}\).}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{\detokenize{M_4f61804aab204341b94d4536fa11bdd0.png}}
